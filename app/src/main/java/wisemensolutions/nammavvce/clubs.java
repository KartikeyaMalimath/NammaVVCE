...
public class clubs extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.home:
                Intent home = new Intent(clubs.this, MainActivity.class);
                startActivity(home);
                break;
            case R.id.about_vvce:
                Intent admini = new Intent(clubs.this, about_vvce.class);
                startActivity(admini);
                break;

            case R.id.facilities:
                Intent facility = new Intent(clubs.this, facility.class);
                startActivity(facility);
                break;

            case R.id.activities:
                Intent activities = new Intent(clubs.this, activitiesandmemo.class);
                startActivity(activities);
                break;

            case R.id.alumni:
                Intent alumni = new Intent(clubs.this, alumni.class);
                startActivity(alumni);
                break;

            case R.id.club:
                Intent club = new Intent(clubs.this, clubs.class);
                startActivity(club);
                break;

            case R.id.app:
                Intent aboutapp = new Intent(clubs.this, about_app.class);
                startActivity(aboutapp);
                break;

            case R.id.gallary:
                Intent gallery = new Intent(clubs.this, gallery.class);
