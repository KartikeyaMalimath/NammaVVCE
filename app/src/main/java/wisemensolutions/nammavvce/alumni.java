...
public class alumni extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.home:
                Intent home = new Intent(alumni.this, MainActivity.class);
                startActivity(home);
                break;
            case R.id.about_vvce:
                Intent admini = new Intent(alumni.this, about_vvce.class);
                startActivity(admini);
                break;

            case R.id.facilities:
                Intent facility = new Intent(alumni.this, facility.class);
                startActivity(facility);
                break;

            case R.id.activities:
                Intent activity = new Intent(alumni.this, activitiesandmemo.class);
                startActivity(activity);
                break;

            case R.id.alumni:
                Intent alumni = new Intent(alumni.this, alumni.class);
                startActivity(alumni);
                break;

            case R.id.club:
                Intent club = new Intent(alumni.this, clubs.class);
                startActivity(club);
                break;

            case R.id.app:
                Intent aboutapp = new Intent(alumni.this, about_app.class);
                startActivity(aboutapp);
                break;

            case R.id.gallary:
                Intent gallery = new Intent(alumni.this, gallery.class);
